...
export const migration = {
    ...
    async up(db: DatabaseAdapter): Promise<void> {
        ...
        const imageUpdates: Array<{ xmlid: string; status: number; comment: string }> = [
            ...
            { xmlid: 'utopiaxaction.image_event.training_statuen_1', status: STATUS.DRAFT, comment: 'draft' },
            ...
            { xmlid: 'utopiaxaction.image_event.training_statuen_2', status: STATUS.DRAFT, comment: 'draft' },
            ...
            { xmlid: 'utopiaxaction.image_event.training_statuen_3', status: STATUS.DRAFT, comment: 'draft' },
        ...
        const projectUpdates: Array<{ domaincode: string; status: number; comment: string }> = [
            ...
            { domaincode: 'utopiaxaction', status: STATUS.RELEASED, comment: 'released - active project' },
