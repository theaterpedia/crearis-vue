...
export const quadrants: QuadrantSpec[] = [
    ...
    // q2 · orange (HP-approved special color · 2026-06-17) · the magnifica question → discourse post-it
    { id: 'q2', theme: 'orange', heading: 'la question magnifique **How can the humanities relate in a sustainable way to high-level AI?**' },
