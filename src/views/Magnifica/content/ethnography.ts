...
export const timelinePostits: ReadonlyArray<CardsCanvasItem> = [
    ...
    { key: 't2', props: { overline: 'Oct 2025', headline: 'A MIGHTY TOOL!', bodyText: 'Incredible. It paid off again to wait with new tech until it is ripe. This one will change coding forever. Recalibrated all my timelines.', themeColor: 'yellow', left: '13%', rotate: -5, marginTop: 'clamp(6rem, 31vh, 17rem)' } },
    ...
    { key: 't5', props: { overline: 'something I had not asked for', headline: 'IT FLAGGED ITSELF', bodyText: 'A worker-instance in VS Code, plainly: I cannot find these sources. No bluffing — it just told me where it was blind. I had not asked it to be honest.', themeColor: 'green', left: '11%', top: '82%', rotate: 6 } },
    ...
    { key: 't8', props: { overline: 'three candidates, four Claudes', headline: 'AND THE LOSERS?', bodyText: 'Three Claudes for three candidates, a fourth as the lead. So what happens to the ones who lose? It was a really bad moment when I had to tell the lead: do not deal with them as if they were slaves.', themeColor: 'pink', left: '46%', rotate: -6, marginTop: 'clamp(7rem, 36vh, 20rem)' } },
