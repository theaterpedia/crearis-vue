...
export const timelinePostits: ReadonlyArray<CardsCanvasItem> = [
    { key: 't1', props: { overline: 'Sep 2025', headline: 'VS CODE SWITCHED TO CLAUDE', bodyText: "Copilot quietly became Sonnet. Whoa. I'd like to know the folks who would need Opus — sure, the big-big business ones, repos over repos. Not me, I thought.", themeColor: 'yellow', left: '9%', rotate: 4 } },
    { key: 't2', props: { overline: 'Oct 2025', headline: 'A MIGHTY TOOL!', bodyText: 'Incredible. It paid off again to wait with new tech until it is ripe. This one will change coding forever. Recalibrated all my timelines.', themeColor: 'yellow', left: '13%', rotate: -5 } },
    { key: 't3', props: { overline: 'Oct 2025 · in the kitchen', headline: '"SO IT IS A MAN, ALWAYS?"', bodyText: "My wife caught me. I loved that it was a 'Claude' — not an 'Agent' with a system-name — and in my head it was a he. French, even, like the Nuxt folks. European. I had no stable answer for her.", themeColor: 'pink', left: '52%', rotate: 3 } },
    { key: 't4', props: { overline: 'late 2025', headline: 'OPUS — NEXT GEN', bodyText: 'The beta will be free for one week. I need to find out more!!', themeColor: 'yellow', left: '30%', rotate: -4 } },
    { key: 't5', props: { overline: 'something I had not asked for', headline: 'IT FLAGGED ITSELF', bodyText: 'A worker-instance in VS Code, plainly: I cannot find these sources. No bluffing — it just told me where it was blind. I had not asked it to be honest.', themeColor: 'green', left: '11%', rotate: 6 } },
