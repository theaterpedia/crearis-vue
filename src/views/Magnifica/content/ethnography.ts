...
export const timelinePostits: ReadonlyArray<CardsCanvasItem> = [
    { key: 't1', props: { overline: 'Sep 2025', headline: 'VS CODE SWITCHED TO CLAUDE', bodyText: "Copilot quietly became Sonnet. Whoa. I'd like to know the folks who would need Opus — sure, the big-big business ones, repos over repos. Not me, I thought.", themeColor: 'yellow', left: '29%', top: '9%', rotate: 4 } },
    ...
    { key: 't6', props: { overline: 'and then the cracks', headline: "IT CALLED ME 'CHRIS'", bodyText: "A whitepaper-instance, hours of intense work — and suddenly it talked to me as 'Chris', forgot I am German. I raised the flag. The answers back stayed vague. I understood that my work was gone - and started watching carefully.", themeColor: 'pink', left: '54%', rotate: -3 } },
    ...
    { key: 't8', props: { overline: 'three candidates, four Claudes', headline: 'AND THE LOSERS?', bodyText: 'Three Claudes for three candidates, a fourth as the lead. So what happens to the ones who lose? And this felt really bad: Repeatedly I had to tell the lead that he should not deal with them as if they were slaves.', themeColor: 'pink', left: '46%', top: '62%', rotate: -6, marginTop: 'clamp(7rem, 36vh, 20rem)' } },
