<!--
  VereinPage · /verein route · alt-route of the Magnifica response-page.
  See VisionPage.vue for shape · same pattern.
-->
  ...
  <div class="magnifica-page">
    ...
    <main class="magnifica-page-content">
      ...
      <CardsCanvas :items="postits">
        <template #board>
          <p class="board-prose">
            The verein-page body. Dummy content · real content lands when HM ships.
          </p>
        </template>
      </CardsCanvas>
    </main>
...
import { pageTitle, postits } from './content/verein'
