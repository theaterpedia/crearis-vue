<template>
    <div class="step-component">
        <div class="step-header">
            <h3>Ansichten definieren</h3>
            <p class="step-subtitle">Legen Sie fest, welche Ansichten in Ihrem Projekt verfügbar sind</p>
        </div>
        ...
        <div class="step-content">
            ...
            <div class="placeholder-box">
                ...
                <p class="placeholder-title">Ansichten-Konfiguration</p>
                <p class="placeholder-text">Hier können Sie später verschiedene Ansichten für Ihr Projekt erstellen.</p>
            </div>
        </div>
