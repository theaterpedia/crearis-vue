 ...
 * 
 * Note: This file is in /utils/ for auto-import across the Nuxt application.
 */
...
export const layoutSettings = {
  /**
   * Site Layout Options:
   * - 'default': Boxed layout with optional right sidebar
   * - 'sidebar': TODO: implement boxed sidebar-layout (currently identical with fullSidebar)
   * - 'fullSidebar': Full-width layout with left navigation sidebar
