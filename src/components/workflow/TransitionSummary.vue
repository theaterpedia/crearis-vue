            ...
            <div v-if="isExpanded" class="summary-content">
                ...
                <div v-if="summary?.changes.length" class="role-changes">
                    ...
                    <div class="changes-list">
                        <div v-for="change in summary.changes" :key="change.relation" class="role-change"
...
.role-change.role-owner {
    border-left-color: oklch(65% 0.14 65);
    /* orange */
}

.role-change.role-creator {
    border-left-color: oklch(65% 0.12 300);
    /* purple */
}

.role-change.role-member {
    border-left-color: oklch(75% 0.12 95);
    /* yellow */
}

.role-change.role-participant {
    border-left-color: oklch(65% 0.10 230);
    /* blue */
}

.role-change.role-partner {
    border-left-color: oklch(60% 0.12 145);
    /* green */
}
