    ...
    <div class="timeline-track">
      ...
      >
        ...
        <button
          ...
          :disabled="!interactive || !isStateAllowed(state.value)"
        ...
        >
          ...
          <span
            v-if="showLayoutBadge && state.value === currentStatus"
            class="layout-badge"
            :class="state.layout"
          >
...
.connector.passed {
  background: oklch(65% 0.15 145); /* green */
}

.connector.active {
  background: oklch(70% 0.15 250); /* blue */
}
...
/* Node States */
.state-node.passed {
  background: oklch(85% 0.12 145); /* light green */
  border-color: oklch(55% 0.15 145); /* dark green */
  color: oklch(30% 0.10 145);
}

.state-node.current {
  background: oklch(85% 0.12 250); /* light blue */
  border-color: oklch(55% 0.15 250); /* dark blue */
...
.state-node.allowed {
  border-color: oklch(65% 0.15 85); /* orange */
}
