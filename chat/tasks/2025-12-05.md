...
> |------|--------------|----------|
> | **'project'** 👑 | Create 2-3 events | THE work. Only type with checkout/payment. |
> | 'topic' | Create a post | Thematic content hub |
> | 'regio' | Configure users & projects | Regional aggregation hub |
> 
> **'project'-type is KING** - where theaterpädagogik happens (events).
...
### Floating Post-Its → Comments Integration
...
- [ ] Update guide for project-stepper ↔ dashboard transitions
